namespace Ders11StructYapilar
{
    ...
    {
        internal string ad;
        // int sayi=5; //struct larda değişkenlere başlangıç değeri 
         internal static int sayi = 5; // başlangıç değeri atamamız gerekirse static tanımlıyamalıyız
        public string metin;
        internal void StructMetot()
        {
            Console.WriteLine("Struct İçerisinde Metot Kullanımı");
        }
    }
